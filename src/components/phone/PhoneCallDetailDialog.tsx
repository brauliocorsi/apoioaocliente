      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4 mt-2">
          ...
          <div className="space-y-2">
            ...
            <ReminderForm phoneCallId={call.id} callSubject={call.subject} callClientName={call.client_name} hasAssignedAgent={!!call.assigned_to} onCreated={() => fetchReminders(call.id)} />
